...
def create_new_entry(filename, question, category, directory="/Users/trashboy/Documents/Repositories/mv/docs/en/questions/dhamma/sort"):
...
if __name__ == "__main__":
    ...
    filename = os.path.join("/Users/trashboy/Documents/Repositories/mv/docs/en/questions/dhamma/sort", clean_filename(question))

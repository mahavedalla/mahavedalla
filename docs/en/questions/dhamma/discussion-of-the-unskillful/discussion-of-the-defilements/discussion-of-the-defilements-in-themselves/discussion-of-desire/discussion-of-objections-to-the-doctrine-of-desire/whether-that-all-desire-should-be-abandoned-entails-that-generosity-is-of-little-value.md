---
Question: Whether that all desire should be abandoned entails that generosity is of little value?
Category: Chanda
Tags: 
Sutta References: 
Date Entered: 2-19-26
Last Revised: 2-19-26
...
# Whether that all desire should be abandoned entails that generosity is of little value?
...
3. Therefore, generosity (to be generous) is of little value.

Strictly speaking, 3 does not follow from 1 or 2 or both. Suppressed premises could be surfaced, but this is not a line I would be inclined to pursue, even steel-manning the defender. Why? Even if it is said that all desire is to be abandoned, this simply means one shouldn't desire generosity, not that one cannot be generous or act generously, which latter point seems to be most relevant.
